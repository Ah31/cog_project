...
if __name__ == "__main__":
    ...
    parser.add_argument("-e", "--env-name", type=str, default="Widow250DoubleDrawerOpenNeutral-v0")
    parser.add_argument("-pl", "--policy-name", type=str, default="drawer_open_transfer")
    parser.add_argument("-a", "--accept-trajectory-key", type=str, default="drawer_opened_success")
    parser.add_argument("-n", "--num-trajectories", type=int, default=100)
    parser.add_argument("-t", "--num-timesteps", type=int,default=30)
